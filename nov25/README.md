For this week's homework, we had to create a program on processing controlled by the arduino board. For my project, when you click on the circle, the LED flashes up.
