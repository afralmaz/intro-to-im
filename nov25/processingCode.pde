...
myPort  =  new Serial (this, "/dev/cu.usbmodem14101",  9600); // Set the com port and the baud rate according to the Arduino IDE
...
if ( mousePressed == true) { // if the left mouse button is pressed
